...
{
    ASTToken hiddenTLbracket; // in ASTImageSelectorNode
    IASTListNode<ASTSectionSubscriptNode> sectionSubscriptList; // in ASTImageSelectorNode
    ASTToken hiddenTRbracket; // in ASTImageSelectorNode
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.hiddenTLbracket = (ASTToken)value; if (value != null) value.setParent(this); return;
        case 1:  this.sectionSubscriptList = (IASTListNode<ASTSectionSubscriptNode>)value; if (value != null) value.setParent(this); return;
        case 2:  this.hiddenTRbracket = (ASTToken)value; if (value != null) value.setParent(this); return;
        default: throw new IllegalArgumentException("Invalid index");
        }
    }
}
