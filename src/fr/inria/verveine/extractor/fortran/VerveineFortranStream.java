...
public class VerveineFortranStream extends FortranStream
{
   ...
   public VerveineFortranStream(String filename) throws IOException
   {
      super(filename);
   }

   public VerveineFortranStream(String filename, String path, int sourceForm) throws IOException
   {
   ...
   public int determineSourceForm(String fileName) {
      if (fileName.endsWith(new String(".f")) == true ||
         ...
         this.sourceForm = VerveineFParser.FIXED_FORM;
         return VerveineFParser.FIXED_FORM;
      } else {
         this.sourceForm = VerveineFParser.FREE_FORM;
         return VerveineFParser.FREE_FORM;
      }
