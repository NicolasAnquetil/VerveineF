...
public class ASTProperLoopConstructNode extends ASTNode implements IExecutableConstruct
{
    ...
    public ASTProperLoopConstructNode(IASTNode parent)
    {
...
//        visitor.visitASTNode(this);
    ...
    @Override protected IASTNode getASTField(int index)
    {
        switch (index)
        {
        case 0:  return new ASTNullNode(); //this.loopHeader;
        case 1:  return this.body;
        case 2:  return new ASTNullNode(); //thisthis.endDoStmt;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  return; //this.loopHeader = (ASTLabelDoStmtNode)value; if (loopHeader != null) loopHeader.setParent(this); break;
        case 1:  this.body = (IASTListNode<IExecutionPartConstruct>)value; if (body != null) body.setParent(this); break;
        case 2:  return; //this.endDoStmt = (ASTEndDoStmtNode)value; if (endDoStmt != null) endDoStmt.setParent(this); break;
        default: throw new IllegalArgumentException();
        }
    }
/*
